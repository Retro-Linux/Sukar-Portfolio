...
var middlewareSecret = "871dbea7-6b19-41ee-9fae-8d6581a1d2f8";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/likes.ts",
			"pathname": "/api/likes",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "871dbea7-6b19-41ee-9fae-8d6581a1d2f8") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
